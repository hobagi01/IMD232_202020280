...
class Ball {
  constructor() {
    ...
    this.radius = 25;
  } //초기 값, 마치 createVector와 같은

  update() {
    //class 안에서는 function 빼기
    this.vel.add(this.acc); //속도도 매번 가속도가 붙음
    this.vel.limit(20); //가속도 한계 걸어주기 , 20보다 커지지는 않도록
...
function update() {
  ...
  //   pos.add(vel);
  //   velA.add(accA); //속도도 매번 가속도가 붙음
  //   velA.limit(20); //가속도 한계 걸어주기 , 20보다 커지지는 않도록
  //   posA.add(velA);
}
